...
#     # Channel unrelated
#     "trigger_source"        :     "EXT",       #  CHANnel1, CHANnel2 , EXTernal , LINE , WGEN  
#     "trigger_level"         :     "1",            #
...
#     "acquire_type"          :     "NORMal",         # NORMal , AVERage , HRESolution , PEAK
#     "acquire_count"         :      "8",            # AVERage=2-65536 ,HRESolution=1 ,NORMal=8 , PEAK=None

#     "waveform_format"       :      "BYTE",          # WORD , BYTE          # Sometimes: despite the format is Word , the osci still sends Byte data, unclear why ?   
...
if __name__ == "__main__":
    ...
    for item , val in osci_shot_configuration.items():
        print(eval(repr(val)) == val)
